...
const basePr: BranchPrStatus = {
	...
	check_details: [
		{ context: "ci/build", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/1" },
		{ context: "ci/test", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/2" },
		{ context: "ci/lint", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/3" },
		{ context: "ci/typecheck", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/4" },
		{ context: "ci/deploy-preview", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/5" },
	],
	author: "sim-user",
	commits: 3,
	mergeable: "MERGEABLE",
...
export const PRESETS: Record<string, Preset> = {
	...
	"pr-conflict": {
		...
		pr: {
			...
			check_details: [
				{ context: "ci/build", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/6" },
				{ context: "ci/test", state: "FAILURE", html_url: "https://github.com/sim/repo/checks/7" },
				{ context: "ci/lint", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/8" },
				{ context: "ci/typecheck", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/9" },
			],
		},
	},
	...
	"pr-draft": {
		...
		pr: {
			...
			check_details: [
				{ context: "ci/build", state: "FAILURE", html_url: "https://github.com/sim/repo/checks/10" },
				{ context: "ci/test", state: "FAILURE", html_url: "https://github.com/sim/repo/checks/11" },
				{ context: "ci/lint", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/12" },
				{ context: "ci/typecheck", state: "PENDING", html_url: "https://github.com/sim/repo/checks/13" },
			],
		},
	},
	...
	"ci-pending": {
		...
		pr: {
			...
			check_details: [
				{ context: "ci/build", state: "PENDING", html_url: "https://github.com/sim/repo/checks/14" },
				{ context: "ci/test", state: "PENDING", html_url: "https://github.com/sim/repo/checks/15" },
				{ context: "ci/lint", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/16" },
				{ context: "ci/typecheck", state: "SUCCESS", html_url: "https://github.com/sim/repo/checks/17" },
				{ context: "ci/deploy-preview", state: "PENDING", html_url: "https://github.com/sim/repo/checks/18" },
			],
		},
	},

							...
							{(branch, idx) => (
								...
								>
									...
									<Show when={branch.is_current}>
										<span data-testid="badge-current" class={`${s.badge} ${s.badgeCurrent}`}>
											current
										</span>
									</Show>
									<Show when={branch.is_remote}>
										<span data-testid="badge-remote" class={`${s.badge} ${s.badgeRemote}`}>
											remote
										</span>
									</Show>
									<Show when={branch.is_main && !branch.is_remote}>
										<span data-testid="badge-main" class={`${s.badge} ${s.badgeMain}`}>
											main
										</span>
									</Show>
								</div>

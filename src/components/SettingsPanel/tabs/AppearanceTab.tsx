	...
	return (
		<div class={s.section}>
			...
			<SettingSelect
				...
				onChange={(v) => {
					if (v === "grouped-by-type" || v === "terminals-first" || v === "free")
						settingsStore.setTabOrderingMode(v);
				}}
				options={[
				...
				hint={t("appearance.hint.tabOrderingMode", "How tabs are ordered: grouped by type, terminals first, or freely interleaved")}
			/>

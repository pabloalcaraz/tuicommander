...
export const PrBadge: Component<PrBadgeProps> = (props) => {
	...
	return <StatusBadge label={`PR #${props.number}`} variant={variant()} title={titleText()} onClick={props.onClick} />;
};
...
export const CiBadge: Component<CiBadgeProps> = (props) => {
	...
	return <StatusBadge label={label()} variant={variant()} title={props.workflowName} />;
};
